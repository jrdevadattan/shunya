...
export function CaseLayout() {
  ...
  return <AppShell header={<div className="case-header"><div><strong>Recovery case</strong><span>{caseId}</span></div><RuntimeModeBadge mode="installed" /></div>} navigation={navigation}><Outlet /></AppShell>;
}
