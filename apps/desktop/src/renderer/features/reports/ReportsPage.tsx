...
export function ReportsPage() {
  ...
  return <section className="workflow-page reports-page">
    ...
    }} /></> : <section className="reports-page__empty"><FileText aria-hidden="true" /><h2>No report generated in this session</h2><p>The daemon will create JSON and Markdown outputs from persisted case evidence when requested.</p></section>}
  </section>;
}
