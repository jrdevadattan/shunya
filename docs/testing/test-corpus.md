...
Validation groups are `unit`, `integration`, `fault`, `security`, `platform`, and `e2e`. Physical-device tests require a loop device, VHD, or disk-image capability variable and never select a host disk.
