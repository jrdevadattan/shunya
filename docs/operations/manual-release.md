...
SIH Recovery Platform releases do not use CI/CD. Every artifact must be built from the same reviewed commit on the operating system it targets. Keep the GitHub release as a draft until the complete release-set check succeeds.
